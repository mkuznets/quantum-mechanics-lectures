...
\begin{defn}
Набор взаимно коммутирующих операторов, собственные значения (квантовые числа) которых однозначно определяют квантовое состояние системы, называют \underbar{полным набором собственных наблюдаемых}.
\end{defn}
