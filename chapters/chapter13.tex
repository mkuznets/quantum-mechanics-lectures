...
$$
P_{nm} = \frac{1}{\hbar} \left | \int_{-\infty}^\infty dt' V_{mn}(t')e^{i \omega_{mn}t'} \right |^2 = \frac{(2\pi)^2}{\hbar^2} \left | V_{mn}(\omega_{mn})\right|^2 - 
$$
...
$|V_{mn}| \ll \hbar \omega_{mn}$ - мало по сравнению с энергией перехода.
