...
Таким образом, плоская монохроматическая волна \underbar{принципиально} не может описывать свободную частицу. Для этого необходимо использовать волновое образование с \underbar{пространственной локализацией}.
