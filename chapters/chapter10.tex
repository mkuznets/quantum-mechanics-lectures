...
$$
\begin{gathered}
R'(\rho) = e^{-\kappa \rho} \rho^l \brs{v' + \brc{\frac{l}{p} - \kappa} v}\\
R''(\rho) = e^{-\kappa \rho} \rho^l \brs{v'' + \brc{\frac{l}{p} - \kappa}v' - \frac{l}{\rho^2}v + \brc{\frac{l}{p} - \kappa} \brs{v' + \brc{\frac{l}{p} - \kappa}v} } = \\ = e^{-\kappa \rho} \rho^l \brs{v'' + 2 \brc{\frac{l}{p} - \kappa} v' + \brc{ \frac{l(l-1)}{\rho^2} - \frac{2\kappa l}{\rho} + \kappa^2 } v }
\end{gathered}
$$

Из \eqref{eq:10_1_2} получаем:
$$
v'' + 2\brc{\frac{l}{p} - \kappa}v' + \brc{ \frac{l(l-1)}{\rho^2} - \frac{2\kappa l}{\rho} + \kappa^2 } v + \frac{2}{\rho}v' + \frac{2}{\rho} \brc{ \frac{l}{p} - \kappa} v + \brc{- \frac{l(l+1)}{\rho^2} + \frac{2Z}{\rho} - \kappa^2}v = 0
$$
...
\label{eq:10_2_7}
\begin{gathered}
\epsilon_n  = \frac{E_n}{E_a} = - \frac{k^2}{2} = \boxed{- \frac{Z^2}{n^2} = \epsilon_n } \\
...
$$
R_{nl}(\rho) = R_{n_r l}(\rho) = C_{nl} e^{-k\rho}\rho^l v_{n_r l}(\rho)
$$
...
$$
\begin{gathered}
\boxed{v_{n_r l}(\rho) = L_{n_r}^{2l+1} (2 k p) }, \text{~где} \\
...
коммутирующего с $\op{H} = \op{\vp^2}/2 - Z/r$ (в а.е), но не коммутирующего с $\op{\vec{l}^2}$. Тогда, в соответствии с теоремой, если $\brs{\op{H}, \op{A}_\alpha} = 0$ (доказательство приведено в Приложении), $\brs{\op{H}, \op{\vec{l}^2}} = 0$, но $\brs{\op{\vec{l}^2}, \op{A}_\alpha} \neq 0$, то это автоматически ведёт к вырождению собственных значений $\op{H}$ по $l$.
