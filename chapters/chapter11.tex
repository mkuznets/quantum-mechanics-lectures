...
\boxed{\Delta \lambdabar \approx \lambdabar \frac{d\lambdabar}{dx} \ll \lambdabar}
\end{gathered}
$$
...
$$
\frac{\hbar}{p^2} \abs{\frac{dp}{dx}} = \abs{\frac{\hbar m}{p^3} \frac{dU}{dx}} \ll 1
$$
...
$$
$$
S_1 = \frac{i\hbar}{2} \ln p(x) = i\hbar \ln \sqrt{p(x)}
$$
...
$$
Вид квазиклассической волновой функции в классически запрешённой области:
$$
\boxed{\left. \psi(x) \right|_{x>x_0} = \mathcal{A} e^{\frac{i}{h} S(x)} \approx \frac{\mathcal{A}}{\sqrt{\abs{p(x)}}} \exp \brc{\pm\frac{1}{h}\int_x^{x_0} \abs{p(x')}dx'} }
$$
\end{enumerate}
...
\item При $p(x_0) = 0$ квазиклассический случай не применим
...
Заменим, что в окрестности $x_0$ функцию $U(x)$ линейным участком:
$$
...
$\abs{x-x_0} < L$, где $L$ --- характерный размер.
...
$$
\brc{\frac{\lambdabar}{L}}^{\frac{2}{3}} L \ll \abs{x-x_0} < L ,~~\text{если}~\frac{\lambdabar}{L} \ll 1
$$

Из \eqref{eq:11_2_1}: $\xi \gg 1$. Приведём асимптотические оценки функций Эйри (см. \textsection b, мат. дополнение т.III Л.-Л.)
$$
\left\{
\begin{aligned}
...
\left\{
\begin{aligned}
\Ai(-\abs{\xi})_{\abs{\xi} \to \infty} &\simeq \frac{1}{\sqrt{\pi}} \xi^{-\frac{1}{4}} \sin\brs{\frac{2}{3} \abs{\xi}^{\frac{3}{2}} + \frac{\pi}{4}} \\
\Bi(-\abs{\xi})_{\abs{\xi} \to \infty} &\simeq \frac{1}{\sqrt{\pi}} \xi^{-\frac{1}{4}} \cos\brs{\frac{2}{3} \abs{\xi}^{\frac{3}{2}} + \frac{\pi}{4}}
\end{aligned}
\right.
$$
...
$$
\begin{aligned}
z_{(x \to x_0 - 0)} &= \frac{1}{\hbar} \int_{x}^{x_0} \alpha^{\frac{1}{2}}\hbar(x_0-x')^{\frac{1}{2}} dx' = \alpha^{\frac{1}{2}} (x_0-x')^{\frac{3}{2}} \equiv \frac{2}{3}\alpha^{\frac{1}{2}} \abs{x-x_0}^{\frac{3}{2}} \equiv \frac{2}{3} \abs{\xi}^{\frac{3}{2}} \\
z_{(x \to x_0 + 0)} &= \frac{1}{\hbar} \int_{x_0}^{x} \alpha^{\frac{1}{2}}\hbar(x'-x_0)^{\frac{1}{2}} dx' = ... = \frac{2}{3} \xi^{\frac{3}{2}}
\end{aligned}
$$
...
\frac{A}{a} = \frac{1}{2},~ \frac{B}{b} = 1 ~~\rightarrow~~ A = \frac{a}{2},~ B = b
\end{gathered}
$$
...
\psi_{II}(x) &\simeq \frac{1}{\sqrt{\abs{p(x)}}} \brcr{ \frac{a}{2} \exp\brc{-\frac{1}{\hbar} \int^x_{x_0} p(x')dx'} + b \exp\brc{-\frac{1}{\hbar} \int^x_{x_0} p(x')dx'} }
\end{aligned}
$$
...
\begin{equation}
\label{eq:11_3_3}
\boxed{\frac{1}{\hbar} \int_{a}^{b} p(x)dx = \pi\hbar\brc{n+\frac{1}{2}}}
\end{equation}

\begin{equation}
\label{eq:11_3_4}
\boxed{\frac{1}{\hbar} \oint p(x)dx \equiv \frac{1}{\hbar} \int_{a}^{b} p(x)dx = 2\pi\hbar\brc{n+\frac{1}{2}}}
\end{equation}
...
= \frac{i\hbar}{2m} \brcr{\frac{A}{\sqrt{p(x)}} e^{i\brs{z(x)+\frac{\pi}{4}}} \frac{A^*}{\sqrt{p(x)}} e^{-i\brs{z(x)+\frac{\pi}{4}}} \brc{-i\frac{dz}{dx}} - \brc{\text{комплексно-сопряжённое}} } = \\
...
$$
\psi(x)_{a<x<b} \simeq \frac{A}{\sqrt{\abs{p}}} \exp\brc{\frac{1}{\hbar} \int_x^{b} \abs{p(x')dx'}} \equiv \frac{A}{\sqrt{\abs{p}}} \underbrace{ \exp\brc{\frac{1}{\hbar} \int_{a}^{b} \abs{p(x')dx'}} }_{e^{\gamma}} \exp\brc{- \frac{1}{\hbar} \int_{a}^{x} \abs{p(x')dx'}}
$$

\item Область I, правило соответствия I:
$$
\psi(x)_{x<a} \simeq \frac{2A}{\sqrt{p}} \sin\brs{\frac{1}{\hbar} \int_{x}^{a} p(x')dx' + \frac{\pi}{4}} e^{\gamma} = \frac
$$
\end{enumerate}
