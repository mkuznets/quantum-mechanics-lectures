...
\underline{Критерий} применимости квазиклассического приближения:
$$
...
\end{gathered}
$$
Существует также формальный \underline{признак} (т.е. необходимое, но недостаточное условие) квазиклассичности (см.~\llref{46}{3}):
$$
...
\underline{Нулевой порядок по $\hbar$}:
$$
\begin{gathered}
...
\underline{Первый порядок по $\hbar$}:
$$
