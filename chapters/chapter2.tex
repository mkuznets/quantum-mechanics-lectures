...
$c(\vp)$ --- \underline{волновая функция в импульсном пространстве}.
...
\begin{defn}
Набор собственных значений $\{f\}$ называется \underline{спектром} оператора $\op{F}$.
\end{defn}

\underline{Дискретный спектр}:
$$\{f\} = f_1,f_2,...,f_n,... $$
...
\underline{Непрерывный спектр}: собственные значения оператора $\op{\vp}$ $p \in (-\infty, +\infty)$
