...
$c(\vp)$ --- амплитуда вероятности (синоним \underbar{волновой функции в импульсном пространстве}).
...
\begin{defn}
$\{f\}$ называется \underbar{спектром} оператора $\op{F}$.
\end{defn}
...
\underbar{Непрерывный спектр}: $p \in (-\infty, +\infty)$